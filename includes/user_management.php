			...
			<table class="widefat">
				<thead>
					<tr>
						...
						<th id="private_group"><?php _e( 'Private Group', 'private_groups' ); ?></th>
						<th id="role"><?php _e( 'Wordpress & bbPress Roles', 'private_groups' ); ?></th>
						<th id="registered"><?php _e( 'Registered', 'private_groups' ); ?></th>
				...
				<tbody>
					...
					if ( $users ) :
						...
						foreach ( $users as $user ) :
							...
							$private_group = $private_group.' '.$rpg_groups[$private_group] ;
							if ($private_group == '') $private_group = 'no group set' ;
							?>
